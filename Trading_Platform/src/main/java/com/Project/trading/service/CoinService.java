...
//		String url = "https://api.coingecko.com/api/v3/coins/"+coinId+"/markets?vs_currency=usd&days=" + days;
		String url = "https://api.coingecko.com/api/v3/coins/" + coinId + "/market_chart?vs_currency=usd&days=" + days+"&x_cg_demo_api_key=" + coingeckoAPI;
	...
	public String getCoinDetails(String coinId) throws Exception {
		String url = "https://api.coingecko.com/api/v3/coins/"+coinId+"&x_cg_demo_api_key=" + coingeckoAPI;
		RestTemplate restTemplate = new RestTemplate();
	...
	public String searchCoin(String keyword) throws Exception {
		String url = "https://api.coingecko.com/api/v3/search?query="+keyword+"&x_cg_demo_api_key=" + coingeckoAPI;
		RestTemplate restTemplate = new RestTemplate();
	...
	public String getTop50CoinsByMarketCapRank() throws Exception {
		String url = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&per_page=50&page=1"+"&x_cg_demo_api_key=" + coingeckoAPI;
		RestTemplate restTemplate = new RestTemplate();
	...
	public String getTrendingCoins() throws Exception {
		String url = "https://api.coingecko.com/api/v3/search/trending?x_cg_demo_api_key=" + coingeckoAPI;
		RestTemplate restTemplate = new RestTemplate();
