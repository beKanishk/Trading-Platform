...
public class ChatBotService implements ChatBotServiceInterface {
	...
	public Coin makeApiRequest(String currencyName) throws Exception {
		...
		String url = "https://api.coingecko.com/api/v3/coins/" + currencyName + "?x_cg_demo_api_key=" + coingeckoAPI;
	...
	public ApiResponse getCoinDetails(String prompt) throws Exception {
		try {
			...
			Coin apiResponse = makeApiRequest(functionResponse.getCurrencyName());
			...
			String body = new JSONObject()
	                ...
	                .put("tools", new JSONArray().put(new JSONObject()
	                        .put("functionDeclarations", new JSONArray().put(new JSONObject()
	                                .put("name", "getCoinDetails")
			...
			ApiResponse ans = new ApiResponse();
	        ans.setMessage("Cannot find coin. Please try to give correct coin name.");
	        return ans;
		}
	}
