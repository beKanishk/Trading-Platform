...
import {CopyIcon, DollarSign, Download, RefreshCw, RotateCw, ShuffleIcon, UploadIcon, WalletIcon } from 'lucide-react'
      ...
      <div className='pt-10 w-full lg:w-[60%]'>
        <Card>
          <CardHeader className="pb-9">
            <div className="flex justify-between items-center">
              ...
              <div>
                <RotateCw onClick={handleFetchUserWallet} className='w-6 h-6 cursor-pointer hover:text-gray-400'/>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <div className='py-5 pt-10'>
          <div className='flex gap-2 items-center pb-5'>
            ...
            <RefreshCw onClick={handleFetchWalletTransaction} className='h-7 w-7 p-0 cursor-pointer hover:text-gray-400'/>

          </div>

          <div className='space-y-5'>
            {wallet.transactions.map((item, i) => <div key={i}>
            <Card className="px-5 flex items-center h-25">
                <div className='flex items-center gap-5 w-full justify-between'>
                  <div className='flex items-center gap-5 flex-1'>
                    ...
                    <div className='space-y-1'>
                      <h1 className="text-left">{item.walletTransactionType || item.purpose}</h1>
